...
<div class="row">
    <div class="col-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.bank-wallet.update', $bank_wallet->id) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_wallet" class="form-control @error('bank_wallet') is-invalid @enderror" value="{{ $bank_wallet->bank_wallet }}" autofocus>
                                @error('bank_wallet')<div class="invalid-feedback">{{ $message }}</span></div>@enderror
                            </div>

                            <div class="form-group">
                                <label>Atas Nama <span class="text-red">*</span></label>
                                <input type="text" name="atas_nama" class="form-control @error('atas_nama') is-invalid @enderror" value="{{ $bank_wallet->atas_nama }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nomor_rekening" class="form-control @error('nomor_rekening') is-invalid @enderror" value="{{ $bank_wallet->nomor_rekening }}">
